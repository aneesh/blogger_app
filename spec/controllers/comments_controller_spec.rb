...
describe CommentsController do
  ...
  let(:valid_attributes) { { "contents" => "MyText" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comment" do
        ...
        Comment.any_instance.should_receive(:update).with({ "contents" => "MyText" })
        put :update, {:id => comment.to_param, :comment => { "contents" => "MyText" }}, valid_session
      end
